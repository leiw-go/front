...
export async function getInitialState(): Promise<{
  ...
  const fetchUserInfo = async () => {
    try {
      ...
      const backendData =
        result as unknown as API.ResponseResult<API.CurrentUserResponse>;
      if (backendData?.data) {
        ...
        return {
          ...
          title: userData.realName || userData.username,
          access: userData.roleCode === 'ADMIN' ? 'admin' : 'user',
        } as API.CurrentUser;
      }
      return result.data;
    } catch (_error) {
...
export const layout: RunTimeLayoutConfig = ({
  ...
  return {
    ...
    // Override title to show real username from currentUser
    title:
