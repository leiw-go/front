export default {
  ...
  'pages.register.username.placeholder': '用户名（2-64位）',
  'pages.register.username.required': '请输入用户名！',
  'pages.register.password.placeholder': '密码（至少6位）',
  'pages.register.password.required': '请输入密码！',
  'pages.register.realName.placeholder': '真实姓名（选填）',
  'pages.register.email.placeholder': '邮箱（选填）',
  'pages.register.phone.placeholder': '手机号（选填）',
};
